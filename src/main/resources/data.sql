...
INSERT INTO public.bus_timing( id, created_at, updated_at, bus_id, bus_stop_id, bus_time, direction)
	VALUES
	(1,now(),now(),1,1,'9:00:00',1),
	(2,now(),now(),1,2,'9:20:00',1),
	(3,now(),now(),1,3,'9:30:00',1),
	(4,now(),now(),1,4,'10:00:00',1),

    (5,now(),now(),1,4,'10:30:00',2),
	(6,now(),now(),1,3,'11:00:00',2),
	(7,now(),now(),1,2,'11:10:00',2),
	(8,now(),now(),1,1,'11:30:00',2),

	(9,now(),now(),2,5,'10:00:00',1),
    (10,now(),now(),2,6,'10:20:00',1),
    (11,now(),now(),2,7,'10:30:00',1),
    (12,now(),now(),2,8,'11:00:00',1),
    (13,now(),now(),2,9,'11:30:00',1)
    ;